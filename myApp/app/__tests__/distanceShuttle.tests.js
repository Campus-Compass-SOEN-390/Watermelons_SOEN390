...
import { findNearestLocation, haversineDistance } from "../utils/distanceShuttle";
...
describe("Find Nearest Location Function", () => {
  ...
  test("should return the first closest location when two are equidistant", () => {
    ...
    const stops = [
      { latitude: 45.5100, longitude: -73.5600 }, // 1st stop
      { latitude: 45.5100, longitude: -73.5600 }, // 2nd stop (same distance)
    ];
