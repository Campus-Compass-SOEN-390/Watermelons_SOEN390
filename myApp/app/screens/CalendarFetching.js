              ...
              <View style={styles.whiteContainer}>
                      ...
                      <ScrollView>
                        {storedCalendarIds.map((item, index) => (
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              handleButtonPress(null, `Selected calendar: ${item.name}`);
                              RNUxcam.logEvent("Stored Calendar Ids Button Pressed");
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    RNUxcam.logEvent("Connect Button Pressed");
                    fetchCalendarEvents();
                  }}
                  disabled={loading}
                >
                ...
                <TouchableOpacity
                  ...
                  onPress={async () => {
                    handleButtonPress(null, "Clearing calendar history");
