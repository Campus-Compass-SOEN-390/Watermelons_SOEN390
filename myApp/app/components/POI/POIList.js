      ...
      <View style={styles.poiItem}>
        ...
        <View style={styles.poiContent}>
          ...
          <View style={styles.categoryContainer}>
            <View
              style={[styles.categoryBadge, getCategoryStyle(item.category)]}
            >
...
const keyExtractor = (item) =>
  item.uniqueKey || item.place_id || Math.random().toString();
...
const POIList = ({
  ...
  return (
    ...
    >
      ...
      {showScrollTopButton && (
        <Animated.View
          style={[styles.scrollTopButton, { opacity: scrollButtonOpacity }]}
        >
          <TouchableOpacity
            onPress={scrollToTop}
